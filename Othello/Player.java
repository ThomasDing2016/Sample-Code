 ...
 * Each player will get to choose where to place their tiles
 */
public interface Player {

	/**
	 * This method will place a tile on the grid. This method should guarantee
	 * correctness of location (no overlaps, must be in a line with another piece)
	 * 
	 * @param retry
	 ...
	 * 
	 * @param move
	 *            Location of the move made by the other player
	 */
